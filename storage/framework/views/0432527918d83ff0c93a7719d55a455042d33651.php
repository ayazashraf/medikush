    ...
    <table class="table table-bordered">
        ...
        <tbody id="dataRecords">
            ...
            <tr>                
                ...
                <td><img src="<?php echo e(url('images/blogs/thumbnail'). '/'.$blog->featured_image); ?>" alt="<?php echo e(strlen($blog->featured_image)>0?$blog->image_caption:''); ?>"></img></td>                
                <?php else: ?>                
...
<?php echo $__env->make('Admin.partials.super', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\concorp\resources\views/Admin/blogs/index.blade.php ENDPATH**/ ?>