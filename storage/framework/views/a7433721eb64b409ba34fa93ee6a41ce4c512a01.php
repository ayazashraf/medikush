    ...
    <table class="table table-bordered">
        ...
        <tbody id="dataRecords">
            ...
            <tr>                
                ...
                <td><img src="<?php echo e(url('images/pages'). '/'.$page->featured_image); ?>" alt="<?php echo e(strlen($page->featured_image)>0?$page->image_caption:''); ?>" style="max-width:150px;"></img></td>                
                <?php else: ?>                
...
<?php echo $__env->make('Admin.partials.super', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MediKush\medikush\resources\views/Admin/pages/index.blade.php ENDPATH**/ ?>